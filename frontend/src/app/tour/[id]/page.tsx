...
export default function TourDetailPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-slate-50 dark:bg-slate-950 text-slate-655 font-bold">
  ...
  return (
    <div className={`min-h-screen bg-slate-50/50 dark:bg-slate-955 font-sans transition-colors duration-300 flex flex-col ${
      ...
      <div className="relative h-[420px] w-full">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/40 to-black/20"></div>

        <div className="absolute bottom-0 left-0 right-0 p-8 sm:p-12 text-white">
          <div className="max-w-7xl mx-auto text-left">
            <span className="inline-block px-3.5 py-1.5 rounded-full text-[10px] font-black tracking-widest uppercase bg-blue-600 text-white mb-4 shadow">
              Hành trình di sản
            </span>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black font-serif leading-tight tracking-wide drop-shadow mb-6">
              {tour.title}
            </h1>
        ...
        <div className="absolute top-6 right-6 flex gap-3">
          <button
            ...
            className="size-11 bg-white/90 dark:bg-slate-900/90 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white dark:hover:bg-slate-800 transition-colors shadow-md cursor-pointer border border-white/20"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full flex-1">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            {/* Reviews */}
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 border border-slate-100/40 dark:border-slate-800/40 shadow-sm text-left">
              <h2 className="text-2xl font-black text-slate-900 dark:text-white mb-6 font-serif leading-tight">Đánh giá từ khách hàng</h2>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 sticky top-24 border border-slate-100/40 dark:border-slate-800/40 shadow-lg text-left">
              <div className="mb-6">
                ...
                <p className="text-xs font-bold text-slate-400 dark:text-slate-550 uppercase tracking-wide">Trọn gói: {tour.duration}</p>
              </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pl-12 pr-4 py-3 border border-slate-150 dark:border-slate-800 bg-transparent rounded-2xl outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-100 dark:focus:ring-blue-900/30 text-slate-800 dark:text-slate-100 font-bold text-sm transition-all"
                    />
                  </div>
                </div>
              ...
              <button
                ...
                className="w-full py-3.5 bg-blue-900 hover:bg-blue-950 dark:bg-blue-600 dark:hover:bg-blue-700 text-white rounded-2xl transition-all mb-3 font-bold text-sm shadow-md cursor-pointer text-center"
              >
                Đặt Hành Trình
              </button>
            ...
            <div className="text-center">
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 px-4 py-2.5 border border-slate-200 dark:border-slate-800 rounded-2xl hover:bg-slate-55 dark:hover:bg-slate-800 transition-colors font-bold text-sm text-slate-700 dark:text-slate-350 cursor-pointer"
                >
                  Quay lại
                </button>
                <button
                  onClick={() => navigate('/cart')}
                  className="flex-1 px-4 py-2.5 bg-blue-900 dark:bg-blue-600 text-white rounded-2xl hover:bg-blue-950 dark:hover:bg-blue-700 transition-colors font-bold text-sm cursor-pointer shadow"
                >
                  Giỏ hàng
                </button>
              </div>
