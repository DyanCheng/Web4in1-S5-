-- Tự động thêm cột vào bảng nếu thiếu
...
VALUES 
  (1, 1, 101, 'Resort Sun Peninsula', 'Bãi Bắc, Bán đảo Sơn Trà, Đà Nẵng', 5, 4.8, 2345, 3500000, 4100000, 'Bán chạy nhất', true),
  (2, 1, 102, 'Dương Đông Boutique Hotel', 'Dương Đông, Phú Quốc', 4, 4.5, 998, 1850000, 2300000, null, true),
  (3, 1, 102, 'Imperial Garden & Spa', 'Trần Hưng Đạo, Phú Quốc', 5, 5.0, 812, 5100000, 6500000, 'Giảm 25%', true),
  (4, 1, 103, 'Nha Trang Bay Resort', 'Đường Trần Phú, Nha Trang', 5, 4.7, 1650, 2450000, 3100000, 'Ưu đãi hè', true),
  (5, 1, 101, 'Đà Nẵng Ocean Hotel', 'Mỹ Khê, Đà Nẵng', 4, 4.6, 1320, 2100000, 2700000, null, true),
  (6, 1, 104, 'Hội An Lantern Villa', 'Phố cổ Hội An, Quảng Nam', 4, 4.4, 760, 1350000, 1800000, null, true),
  (7, 1, 105, 'Sa Pa Mountain Lodge', 'Trung tâm Sa Pa, Lào Cai', 4, 4.3, 524, 1650000, 2100000, null, true),
  (8, 1, 106, 'Hạ Long Pearl Hotel', 'Bãi Cháy, Hạ Long', 4, 4.2, 690, 1750000, 2200000, null, true),
  (9, 1, 107, 'Đà Lạt Pine Garden', 'Hồ Tuyền Lâm, Đà Lạt', 3, 4.1, 430, 1250000, 1650000, null, true),
  (10, 1, 108, 'Hà Nội Heritage Hotel', 'Hoàn Kiếm, Hà Nội', 4, 4.5, 1180, 1950000, 2500000, null, true),
  (11, 1, 109, 'Sài Gòn Sky Suites', 'Quận 1, TP. Hồ Chí Minh', 5, 4.9, 2012, 3650000, 4550000, 'Được yêu thích', true),
  (12, 1, 110, 'Huế Riverside Hotel', 'Bờ sông Hương, Huế', 4, 4.6, 850, 1550000, 2000000, null, true);
...
VALUES 
  (1, 1, 'Phòng Superior Hướng Biển', 3500000, 350000, 2, '1 Giường đôi', 42, 'https://images.unsplash.com/photo-1611892440504-42a792e24d32'),
  (2, 1, 'Phòng Deluxe Gia Đình', 4800000, 480000, 4, '2 Giường đôi', 65, 'https://images.unsplash.com/photo-1590490360182-c33d57733427'),
  (3, 1, 'Suite Toàn Cảnh', 7500000, 750000, 2, '1 Giường King', 85, 'https://images.unsplash.com/photo-1578683010236-d716f9a3f461'),
  (4, 2, 'Phòng Tiêu Chuẩn', 1850000, 185000, 2, '1 Giường đôi', 30, 'https://images.unsplash.com/photo-1598928506311-c55dd713b41d'),
  (5, 2, 'Phòng Hướng Vườn', 2200000, 220000, 2, '2 Giường đơn', 35, 'https://images.unsplash.com/photo-1631049307264-da0ec9d70304'),
  (6, 3, 'Suite Vườn Ngự Uyển', 5100000, 510000, 2, '1 Giường King', 70, 'https://images.unsplash.com/photo-1618773928121-c32242e63f39'),
  (7, 3, 'Biệt Thự Hồ Bơi Riêng', 12500000, 1250000, 6, '3 Giường King', 250, 'https://images.unsplash.com/photo-1582719478250-c89cae4dc85b'),
  (8, 4, 'Phòng Deluxe Hướng Biển', 2450000, 245000, 2, '1 Giường đôi', 45, 'https://images.unsplash.com/photo-1590490359683-658d34c8f0d8'),
  (9, 4, 'Biệt Thự Trên Nước', 8900000, 890000, 4, '2 Giường King', 120, 'https://images.unsplash.com/photo-1571896349842-33c89424de2d');
...
BEGIN
  ...
  FROM (
    SELECT 
      ...
      ARRAY['Điều hoà', 'Tivi', 'Minibar'] AS facilities
