    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <h1 className="text-3xl text-gray-900 mb-4">Giỏ hàng trống</h1>
      ...
      <header className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <Link to="/" className="text-blue-600 hover:text-blue-700">← Tiếp tục mua</Link>
          </div>
        </div>
      </header>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <h1 className="text-3xl text-gray-900 mb-8">Giỏ hàng của bạn</h1>
              ...
              <div key={item.id} className="bg-white rounded-xl p-6">
                <div className="flex gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 mb-2">Ngày: {item.date}</p>
                    <p className="text-sm text-gray-600 mb-4">Số người: {item.guests}</p>

                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <button
                          onClick={() => updateQuantity(item.id, item.quantity - 1)}
                          className="size-8 border rounded-lg flex items-center justify-center hover:bg-gray-50"
                        >
                      ...
                      <div className="flex items-center gap-4">
                        <span className="text-2xl text-blue-600">{(item.price * item.quantity).toLocaleString('vi-VN')}đ</span>
                        <button
